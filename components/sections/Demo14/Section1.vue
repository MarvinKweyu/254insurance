            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="hero-14-txt color--white wow fadeInUp">
                        <!-- Title -->
                        <h2 class="s-60 w-700">Automate your way to success with 254Insurance</h2>
                        <!-- Text -->
                        <p class="s-21">Mauris donec ociis diam magnis sapien sagittis sapien tempor volute gravida and
                            aliquet tortor undo aliquet in quaerat tortor</p>
                        <!-- HERO QUICK FORM -->
                        ...
                        <!-- Text -->
                        <p class="btn-txt ico-15"><span class="flaticon-check"></span> 14-day free trial. No credit card
                            needed,</p>
                    </div>
                </div>
            </div>
