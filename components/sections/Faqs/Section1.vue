            ...
            <div class="row justify-content-center">
                <div class="col-lg-11 col-xl-10">
                    <div class="inner-page-title">
                        ...
                        <p class="p-lg">Some common questions we get about 254Insurance</p>
                    </div>
                        ...
                        <ul>
                            <ElementsAccordionItem title="Getting Started">
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-question">
                                        <h5 class="s-22 w-700"><span>1.</span> What is 254Insurance and how does it work?
                                        </h5>
                                    </div>
                                    <!-- Answer -->
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna ipsum
                                            vitae purus congue efficitur and ipsum primis in cubilia laoreet augue egestas
                                            luctus donec and curabitur dapibus</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #1 -->
                                <!-- QUESTION #2 -->
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas and magna
                                            ipsum vitae purus and efficitur ipsum primis in cubilia laoreet tempor gravida
                                            congue laoreet turpis neque auctor</p>
                                        <!-- Text -->
                                        <p>Sapien egestas, congue gestas posuere cubilia congue ipsum mauris undo lectus
                                            laoreet and gestas neque vitae auctor eros dolor luctus placerat a magna cursus
                                            congue magna impedit ligula congue maecenas</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #2 -->
                                <!-- QUESTION #3 -->
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                                        <h5 class="s-22 w-700"><span>3.</span> Which languages does 254Insurance support?
                                        </h5>
                                    </div>
                                    <!-- Answer -->
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <ul class="simple-list">
                                            <li class="list-item">
                                                <p>Curabitur ac dapibus libero quisque eu congue tristique neque. Phasellus
                                                    blandit tristique justo aliquam quisque aliquam vitae and molestie
                                                    sapien nunc justo, aliquet non molestie purus tempor</p>
                                            </li>
                                            <li class="list-item">
                                                <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas
                                                    magna ipsum undo purus vitae efficitur ipsum primis in cubilia laoreet
                                                    augue donec egestas luctus curabitur dapibus libero</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-panel-item">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <p>An augue cubilia laoreet and magna suscipit egestas magna ipsum purus ipsum
                                            primis and augue ultrice ligula egestas suscipit lectus gestas integer congue a
                            ...
                            <ElementsAccordionItem title="Manage your account">
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna ipsum
                                            vitae purus congue and efficitur ipsum primis in cubilia laoreet augue egestas
                                            luctus donec and curabitur dapibus</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #2 -->
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        <p>Sapien egestas, congue gestas posuere cubilia congue ipsum mauris lectus laoreet
                                            gestas neque pulvinar vitae auctor eros dolor luctus placerat a magna cursus
                                            congue magna nihil mpedit ligula congue. Maecenas gravida porttitor nunc, quis
                                            vehicula magna luctus tempor. Quisque vel laoreet turpis. Viverra augue augue
                                            eget, dictum tempor diam. Sed pulvinar a consectetur nibh, imperdiet varius
                                            viverra</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #3 -->
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas and magna
                                            ipsum vitae</p>
                                        <!-- Text -->
                                        <p>Sagittis congue augue egestas volutpat egestas and magna suscipit egestas magna
                                            ipsum vitae efficitur purus congue ipsum primis in cubilia laoreet augue egestas
                                            luctus donec and curabitur dapibus</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #4 -->
                                ...
                                <div class="accordion-panel-item">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        <p>Sapien egestas, congue gestas posuere cubilia congue ipsum mauris lectus laoreet
                                            at gestas neque cubilia vitae auctor eros dolor luctus placerat a magna cursus
                                            congue magna nihil mpedit ligula congue. Maecenas gravida porttitor nunc, quis
                                            vehicula magna luctus tempor. Quisque vel laoreet turpis augue</p>
                                        <!-- Text -->
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas and magna
                                            ipsum and vitae purus efficitur ipsum primis in cubilia laoreet tempor gravida
                                            sapien cursus congue magna purus quaerat</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #5 -->
                            </ElementsAccordionItem>
                            <ElementsAccordionItem title="Purchase and License">
                                ...
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                                        <h5 class="s-22 w-700"><span>1.</span> How much does 254Insurance cost?</h5>
                                    </div>
                                    <!-- Answer -->
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <!-- Text -->
                                        <p>Sagittis congue augue egestas volutpat egestas and magna suscipit egestas magna
                                            ipsum vitae purus congue efficitur ipsum primis in cubilia laoreet augue egestas
                                            luctus donec and curabitur dapibus</p>
                                    </div>
                                </div>
                                <!-- END QUESTION #2 -->
                                ...
                                <div class="accordion-panel-item">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        ...
                                        <ul class="simple-list">
                                            <li class="list-item">
                                                <p>Curabitur ac dapibus libero. Quisque eu congue tristique neque phasellus
                                                    blandit tristique justo aliquam. Aliquam vitae undo molestie nunc.
                                                    Quisque sapien justo, aliquet non molestie purus tempor</p>
                                            </li>
                                            <li class="list-item">
                                                <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas
                                                    magna ipsum vitae purus undo efficitur ipsum primis in cubilia laoreet
                                                    augue egestas luctus donec curabitur dapibus libero</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-panel-item">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                                        <h5 class="s-22 w-700"><span>4.</span> I can't activate 254Insurance</h5>
                                    </div>
                                    <!-- Answer -->
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        ...
                                        <ul class="simple-list">
                                            ...
                                            <li class="list-item">
                                                <p>Congue tristique neque phasellus blandit tristique justo undo aliquam
                                                    aliquam vitae molestie quisque sapien justo, aliquet non molestie purus
                                                    tempor</p>
                                            </li>
                                            <li class="list-item">
                                                <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas
                            ...
                            <ElementsAccordionItem title="Policy, Safety & Copyright">
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna ipsum
                                            vitae purus congue efficitur ipsum and primis undo cubilia a laoreet augue
                                ...
                                <div class="accordion-panel-item mb-35">
                                    ...
                                    <div class="faqs-2-answer color--grey">
                                        <!-- Text -->
                                        <p>Sapien egestas, congue gestas posuere cubilia congue ipsum mauris lectus laoreet
                                            and gestas neque vitae auctor eros dolor luctus placerat a magna cursus congue
                                            magna nihil mpedit ligula congue maecenas undo gravida porttitor nunc, quis
                                            vehicula magna luctus tempor. Quisque vel laoreet turpis augue</p>
                                        <!-- Text -->
                                        <ul class="simple-list">
                                            <li class="list-item">
                                                <p>Congue tristique neque phasellus blandit tristique justo undo aliquam
                                                    aliquam vitae molestie quisque and sapien justo, aliquet non molestie
                                                    purus tempor</p>
                                            </li>
                                            <li class="list-item">
                                                <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas
                            ...
                            <ElementsAccordionItem title="Other Questions">
                                ...
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                                        <h5 class="s-22 w-700"><span>2.</span> I forgot my folder password, what should I
                                            do?</h5>
                                    </div>
                                    <!-- Answer -->
                                <div class="faqs-2-answer color--grey">
                                    <!-- Text -->
                                    <p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna ipsum
                                        vitae purus congue efficitur ipsum and primis in cubilia laoreet augue egestas
                                        luctus donec and curabitur dapibus</p>
                                    <!-- Text -->
                                    <ol class="digit-list">
                                        <li class="list-item">
                ...
                <div class="more-questions">
                    <div class="more-questions-txt bg--white-400 r-100">
                        <p class="p-lg">Have any questions? <NuxtLink to="/contacts" class="color--theme">Get in Touch
                            </NuxtLink>
                        </p>
                    </div>
                </div>
